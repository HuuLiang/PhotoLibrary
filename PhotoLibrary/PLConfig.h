...
#define PL_PAYMENT_CONFIG_URL          @"http://120.24.252.114:8084/paycenter/payConfig.json"//@"http://pay.iqu8.net/paycenter/payConfig.json"//
#define PL_STANDBY_PAYMENT_CONFIG_URL   @"http://appcdn.mqu8.com/static/iosvideo/payConfig_%@.json"
#define PL_PAYMENT_COMMIT_URL           @"http://120.24.252.114:8084/paycenter/qubaPr.json" //@"http://pay.iqu8.net/paycenter/qubaPr.json"//
